...
- (UIBezierPath *)pathForBox {
    ...
    switch (self.boxType) {
        case BEMBoxTypeSquare:
            path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0.0 + (self.boxLineWidth / 2.0), 0.0 + (self.boxLineWidth / 2.0), self.size - self.boxLineWidth, self.size - self.boxLineWidth) cornerRadius:self.cornerRadius];
        ...
        default: {
            CGFloat radius = (self.size / 2.0) - (self.boxLineWidth / 2.0);;
